...
?>
    ...
    <div class="login-container">
        <div class="login-form-wrapper">
            ...
            <form action="/ccmart2/php/login_process.php" method="post" id="login-form">
                ...
                <div class="register-link">
                    <p>Don't have an account? <a href="/ccmart2/register.php" id="register-link">Please register here</a></p>
                </div>
            </form>
        </div>
    </div>
